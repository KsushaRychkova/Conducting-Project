...
public class MidiFileSelectWindow extends JFrame implements Runnable, ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(command.equals("Select a file...")) { // if user clicked the select button
			...
			chooser.setDialogTitle("Select a .mid file"); // title of the chooser window
			...
			FileNameExtensionFilter restriction = new FileNameExtensionFilter("Midi Files (*.mid)", "mid"); // only .mid files
	...
	public void run() {
        ...
        setTitle("Conducting Animation - Select the .mid file");
        ...
        extraText = new JLabel("Please select a .mid file, then click confirm."); // nothing for now
